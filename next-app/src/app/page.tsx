          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl lg:text-2xl mb-8 text-blue-100 leading-relaxed">
                ...
                with resources for housing, education, recovery meetings, and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Founded by individuals with collective 70+ years of prison
              experience, now dedicated to transforming lives and building
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-gray-600">
                Collective prison experience transformed into community service
              </div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-blue-600 mb-2">
              ...
              <div className="text-gray-600">
                Transitional housing, halfway houses, and long-term options
              </div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-blue-600 mb-2">
              ...
              <div className="text-gray-600">
                AA and NA meetings across Washington State
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Three individuals who transformed their lives and are now
              dedicated to helping others build successful bridges back to
              community.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Chad's journey from incarceration to community leadership
                  demonstrates the power of transformation and second chances.
                </p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Dustin specializes in connecting individuals with housing and
                  educational resources, drawing from his own reentry
                  experience.
                </p>
                <Button asChild variant="outline" className="w-full">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Christopher focuses on recovery meeting coordination and
                  building supportive community networks for sustainable
                  reentry.
                </p>
                <Button asChild variant="outline" className="w-full">
                  <Link href="/founders/christopher">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-blue-600">
              <CardHeader>
                ...
                <CardDescription>
                  Find transitional housing, halfway houses, and long-term
                  options
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Searchable database of housing resources across Washington
                  State with application guidance.
                </p>
            ...
            <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-green-600">
              <CardHeader>
                ...
                <CardDescription>
                  AA and NA meetings with locations and schedules
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Comprehensive directory of recovery meetings with search by
                  location and time.
                </p>
                <Button
                  asChild
            ...
            <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-purple-600">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Educational opportunities and vocational training programs to
                  build your future.
                </p>
                <Button
                  asChild
